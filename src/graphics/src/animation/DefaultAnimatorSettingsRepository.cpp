...
const std::string DefaultAnimatorSettingsRepository::animatorSettingsFilePath{utils::getProjectPath("chimarrao-platformer") + "config/animators.yaml"};
...
{
    const auto animatorsSettingsAsVector = animatorSettingsReader->readAnimatorsSettings(animatorSettingsFilePath);
...
boost::optional<AnimatorSettings> DefaultAnimatorSettingsRepository::getAnimatorSettings(const std::string& animatorName) const
{
