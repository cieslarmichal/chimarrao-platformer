...
TEST_F(DistanceAttackTest, givenTargetInAttackRangeOnRight_shouldDealDamageToTarget)
{
...
TEST_F(DistanceAttackTest, givenTargetOutOfAttackRangeOnRight_shouldNotDealAnyDamageToTarget)
{
    quadtree->insertCollider(boxColliderComponent1);
...
TEST_F(DistanceAttackTest, givenTargetInAttackRangeOnLeft_shouldDealDamageToTarget)
{
    quadtree->insertCollider(boxColliderComponent1);
...
TEST_F(DistanceAttackTest, givenTargetOutOfAttackRangeOnLeft_shouldNotDealAnyDamageToTarget)
{
    quadtree->insertCollider(boxColliderComponent1);
