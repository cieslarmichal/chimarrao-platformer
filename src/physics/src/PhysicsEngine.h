...
public:
    ...
    virtual utils::Vector2f getPosition(const PhysicsId&) = 0;
    virtual utils::Vector2i getMovementDirection(const PhysicsId&) const = 0;
    virtual utils::Vector2f getMovementSpeed(const PhysicsId&) const = 0;
    virtual void setPosition(const PhysicsId&, const utils::Vector2f&) = 0;
