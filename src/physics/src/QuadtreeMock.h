...
{
public:
    MOCK_METHOD(void, insertCollider, (const std::shared_ptr<components::core::BoxColliderComponent>&),
                (override));
    MOCK_METHOD(void, removeCollider, (const std::shared_ptr<components::core::BoxColliderComponent>&),
                (override));
